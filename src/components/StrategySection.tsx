          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="space-y-6">
              {strategySteps.map((step, index) => (
                <div
                  key={step.title}
                  className="group relative flex gap-6 p-6 rounded-2xl gradient-card border border-border/50 shadow-soft hover:shadow-card transition-all duration-500 hover:-translate-x-2"
                >
                  {/* Step Number */}
