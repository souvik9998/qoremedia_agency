      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {trustItems.map((item, index) => (
            <div
              key={item.title}
              className="group p-6 sm:p-8 rounded-2xl gradient-card border border-border/50 shadow-soft hover:shadow-card transition-all duration-500 hover:-translate-y-2"
